...
//how to render the template.
  res.render('shop', {prods: adminData.products, pageTitle: 'Shop', path:"/shop"}); //don't have to give the template name since the template type was provided in the app.js
